                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <?php
                                            for($i=0;$i<count($users);$i++){
                                                ...
                                                $image_path=json_decode($users[$i]['image_url'],true);
                                                ...
                                                echo"<td>".$email."</td>";
                                                echo"<td>".$position."</td>";
                                                echo"<td> <a href='../../database/user_give_access.php?userId=".$user_id."'>Give</a> | <a href='../../database/user_remove_access.php?userId=".$user_id."'>Deny</a> </td>";
                                                echo"<td> <a href='./edit_user.php?userId=".$user_id."'>Edit</a> | <a href='../../database/delete_user.php?userId=".$user_id."'>Delete</a></td>";
                                                echo "</tr>";
                                            }
                                        ?>
                                        </tbody>
