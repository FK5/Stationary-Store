    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                  <button type="button" class="btn btn-primary btn-circle-lg" onclick="add_to_checkout()"><i class="fa fa-plus"></i>
                              </button>
                    <div class="col-7 align-self-center">

                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add To Checkout</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                  <form method="post" action="../../database/add_to_checkout.php" id="form-quantity">
