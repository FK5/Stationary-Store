...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                  <button type="button" class="btn btn-primary btn-circle-lg" onclick="confirm_purchase()"><i class="fa fa-shopping-bag"></i>
                              </button>
                    <div class="col-7 align-self-center">

                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Confirm Purchase</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="" class="text-muted">You can call our firm to cancel any recent order</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            <?php
                                            if(isset($_SESSION['pids']) && isset($_SESSION['quantities'])){
                                                for($i=0;$i<count($_SESSION['pids']);$i++){
                                                  $someting=$_SESSION['pids'][$i];
                                                  $sql = "SELECT * FROM product WHERE product_id=$someting";
                                                  $query_result = mysqli_query($conn, $sql);
                                                  while($record = mysqli_fetch_assoc($query_result)) {
                                                    $product[] = $record;
                                                  }
                                                    ...
                                                    echo"<td>".$_SESSION['quantities'][$i]."</td>";
                                                    echo"<td>".$price."</td>";
                                                    echo"<td>".$price*$_SESSION['quantities'][$i]."</td>";
                                                    echo "</tr>";
                                                    unset($product);
                                                }
                                              }
    ...
    function confirm_purchase() {
      window.location.href = '../../database/confirm_purchase.php';
    }
 </script>
</body>
